-- supabase/seed/local_seed.sql
-- Local development seed for Better Off Local.
--
-- Prerequisites:
--   1. Local Supabase stack running: supabase start
--   2. Migrations applied: supabase db push
--   3. Four auth users created via Supabase Studio (http://localhost:54323)
--      or via the CLI: supabase auth signup --email ... --password ...
--
...
--
--   4. Run this script:
--        psql postgresql://postgres:postgres@localhost:54322/postgres -f supabase/seed/local_seed.sql
--
...
--    To test the real Stripe checkout flow, use a second clean account.
-- ─────────────────────────────────────────────────────────────────────────────
